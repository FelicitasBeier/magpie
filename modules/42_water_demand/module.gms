...
*' @title Water demand
*'
*' @description The water demand module determines irrigation water demand.
*' Agriculture, manufacturing, electricity and domestic water usage is determined exogenously.
*' Water requirements for the ecosystem are scenario-dependent / optional.
