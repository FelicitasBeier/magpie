...
$Ifi "%phase%" == "sets" $include "./modules/42_water/all_sectors_aug13/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/42_water/all_sectors_aug13/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/42_water/all_sectors_aug13/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/42_water/all_sectors_aug13/equations.gms"
$Ifi "%phase%" == "scaling" $include "./modules/42_water/all_sectors_aug13/scaling.gms"
$Ifi "%phase%" == "preloop" $include "./modules/42_water/all_sectors_aug13/preloop.gms"
$Ifi "%phase%" == "presolve" $include "./modules/42_water/all_sectors_aug13/presolve.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/42_water/all_sectors_aug13/postsolve.gms"
